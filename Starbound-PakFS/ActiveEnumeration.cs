...
// A copy can be viewed online here: https://github.com/Microsoft/ProjFS-Managed-API/blob/master/LICENSE
...
namespace PakFS
{
    ...
    {
        private readonly IEnumerable<PakFileSystemInfo> fileInfos;
        private IEnumerator<PakFileSystemInfo> fileInfoEnumerator;
        private string filterString = null;

        public ActiveEnumeration(List<PakFileSystemInfo> fileInfos)
        {
        ...
        /// </summary>
        public PakFileSystemInfo Current
        {
